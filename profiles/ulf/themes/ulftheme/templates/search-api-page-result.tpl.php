...
<div class="search-module--result">
  <h3 class="search-module--result-header">
    <?php print $url ? l($title, $url['path'], $url['options']) : check_plain($title); ?>
  </h3>
  <div class="search-module--result-author"><?php print t('Provider') . ': ' . $username;?></div>
  <div class="search-module--result-image">
    <?php if(!empty($image)) : ?>
      <?php print $image;?>
    <?php endif;?>
  </div>
  <div class="search-module--result-content">
    <?php if(!empty($result_text)) : ?>
      <?php print $result_text;?>
    <?php endif;?>
  </div>
  <div class="search-module--node-link">
    <?php print $url ? l($title, $url['path'], $url['options']) : check_plain($title); ?>
  </div>
</div>