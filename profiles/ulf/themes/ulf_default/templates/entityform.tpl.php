...
<div class="content--main"<?php print $content_attributes; ?>>
  <?php
    hide($content['info']);
  ?>
  <?php if(property_exists($elements['#entity'], 'field_message_name')) {?>
  ...
  <?php if(property_exists($elements['#entity'], 'field_message_email')) {?>
  <div class="block--field-wrapper">
  ...
  <?php if(property_exists($elements['#entity'], 'field_message_body')) {?>
  <div class="block--field-wrapper">
